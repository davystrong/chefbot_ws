...
if("TRUE" STREQUAL "TRUE")
  set(chefbot_bringup_SOURCE_PREFIX /home/usrl/chefbot_ws/src/Chefbot_ROS_pkg/chefbot/chefbot_bringup)
  set(chefbot_bringup_DEVEL_PREFIX /home/usrl/chefbot_ws/devel)
  ...
  set(chefbot_bringup_INSTALL_PREFIX /home/usrl/chefbot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'chefbot_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/usrl/chefbot_ws/src/Chefbot_ROS_pkg/chefbot/chefbot_bringup/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT chefbot_bringup_NUM_DUMMY_TARGETS)
      set(chefbot_bringup_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::chefbot_bringup::wrapped-linker-option${chefbot_bringup_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR chefbot_bringup_NUM_DUMMY_TARGETS "${chefbot_bringup_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::chefbot_bringup::wrapped-linker-option${chefbot_bringup_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND chefbot_bringup_LIBRARIES "${interface_target_name}")
